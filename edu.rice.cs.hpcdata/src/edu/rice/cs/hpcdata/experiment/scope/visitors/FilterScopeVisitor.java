...
public class FilterScopeVisitor implements IScopeVisitor 
{
	 ...
	 */
	private void removeChild(Iterator<TreeNode> iterator, Scope childToRemove, ScopeVisitType vt, FilterAttribute.Type filterType)
	{
	 ...
	 * @see FilterAttribute.Type
	 */
	private Scope removeNode(Iterator<TreeNode> iterator, Scope child, FilterAttribute.Type filterType) {
